...
# Render provee URLs con "postgres://" pero SQLAlchemy necesita "postgresql://"
...
if __name__ == '__main__':
    with app.app_context():
        db.create_all() # Crea las tablas en SQLite
        seed_database() # Inserta catálogos y pedido de prueba
